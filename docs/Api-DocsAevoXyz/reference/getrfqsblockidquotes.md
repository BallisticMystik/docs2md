Title: GET /rfqs/{block_id}/quotes

URL Source: https://api-docs.aevo.xyz/reference/getrfqsblockidquotes
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getrfqsblockidquotes#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getrfqsblockidquotes)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getrfqsblockidquotes)
...
get https://api.aevo.xyz/rfqs/{block\_id}/quotes
