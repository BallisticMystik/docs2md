Title: DELETE /rfqs/{block_id}

URL Source: https://api-docs.aevo.xyz/reference/deleterfqsblockid

Markdown Content:
DELETE /rfqs/{block\_id}
===============
                                                                                                                   

[Jump to Content](https://api-docs.aevo.xyz/reference/deleterfqsblockid#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/deleterfqsblockid)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/deleterfqsblockid)
...
delete https://api.aevo.xyz/rfqs/{block\_id}
