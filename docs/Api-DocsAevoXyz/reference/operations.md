...
URL Source: https://api-docs.aevo.xyz/reference/operations

Markdown Content:
Operations
=============== 

[Jump to Content](https://api-docs.aevo.xyz/reference/operations#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/operations)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/operations)
...
PUB
 ...
 | **PUBLISH** | One time call to a specific `op` code. This similar to calling a HTTP request such as a `GET` or a `POST` request. |
| 

SUB

 | **SUBSCRIBE** | Subscription to a channel. After subscribing successfully, the client will receive updates periodically from the server. |

Updated almost 2 years ago

* * *

[Endpoints](https://api-docs.aevo.xyz/reference/endpoints)[Message Format](https://api-docs.aevo.xyz/reference/messaging-format-1)
