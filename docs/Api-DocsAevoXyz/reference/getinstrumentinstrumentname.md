Title: GET /instrument/{instrument_name}

URL Source: https://api-docs.aevo.xyz/reference/getinstrumentinstrumentname
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getinstrumentinstrumentname#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getinstrumentinstrumentname)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getinstrumentinstrumentname)
...
get https://api.aevo.xyz/instrument/{instrument\_name}
