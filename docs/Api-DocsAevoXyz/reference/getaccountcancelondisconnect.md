Title: GET /account/cancel-on-disconnect

URL Source: https://api-docs.aevo.xyz/reference/getaccountcancelondisconnect
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getaccountcancelondisconnect#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountcancelondisconnect)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountcancelondisconnect)
...
get https://api.aevo.xyz/account/cancel-on-disconnect
