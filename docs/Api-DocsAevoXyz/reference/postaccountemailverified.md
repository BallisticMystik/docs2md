Title: POST /account/email-verified

URL Source: https://api-docs.aevo.xyz/reference/postaccountemailverified
...
[Jump to Content](https://api-docs.aevo.xyz/reference/postaccountemailverified#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountemailverified)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountemailverified)
...
post https://api.aevo.xyz/account/email-verified
