Title: GET /strategies/account-history

URL Source: https://api-docs.aevo.xyz/reference/getstrategiesaccounthistory
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getstrategiesaccounthistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategiesaccounthistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategiesaccounthistory)
...
get https://api.aevo.xyz/strategies/account-history
