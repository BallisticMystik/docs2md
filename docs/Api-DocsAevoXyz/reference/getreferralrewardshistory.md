Title: GET /referral-rewards-history

URL Source: https://api-docs.aevo.xyz/reference/getreferralrewardshistory
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getreferralrewardshistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getreferralrewardshistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getreferralrewardshistory)
...
get https://api.aevo.xyz/referral-rewards-history
