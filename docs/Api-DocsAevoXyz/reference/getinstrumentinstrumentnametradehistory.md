Title: GET /instrument/{instrument_name}/trade-history

URL Source: https://api-docs.aevo.xyz/reference/getinstrumentinstrumentnametradehistory

Markdown Content:
GET /instrument/{instrument\_name}/trade-history
===============
                                                                                                                        

[Jump to Content](https://api-docs.aevo.xyz/reference/getinstrumentinstrumentnametradehistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getinstrumentinstrumentnametradehistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getinstrumentinstrumentnametradehistory)
...
get https://api.aevo.xyz/instrument/{instrument\_name}/trade-history
