Title: GET /strategies/account

URL Source: https://api-docs.aevo.xyz/reference/getstrategiesaccount
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getstrategiesaccount#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategiesaccount)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategiesaccount)
...
get https://api.aevo.xyz/strategies/account
