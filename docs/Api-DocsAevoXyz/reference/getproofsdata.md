Title: GET /proofs-data

URL Source: https://api-docs.aevo.xyz/reference/getproofsdata
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getproofsdata#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getproofsdata)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getproofsdata)
...
get https://api.aevo.xyz/proofs-data
