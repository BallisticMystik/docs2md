Title: POST /campaign-sign-up

URL Source: https://api-docs.aevo.xyz/reference/postcampaignsignup
...
[Jump to Content](https://api-docs.aevo.xyz/reference/postcampaignsignup#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postcampaignsignup)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postcampaignsignup)
...
post https://api.aevo.xyz/campaign-sign-up
