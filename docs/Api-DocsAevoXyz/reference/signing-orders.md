...
URL Source: https://api-docs.aevo.xyz/reference/signing-orders
...
[Jump to Content](https://api-docs.aevo.xyz/reference/signing-orders#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/signing-orders)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/signing-orders)
...
[](https://api-docs.aevo.xyz/reference/signing-orders#method)
-----------------------------------------------------------------------
...
[](https://api-docs.aevo.xyz/reference/signing-orders#example)
-------------------------------------------------------------------------
