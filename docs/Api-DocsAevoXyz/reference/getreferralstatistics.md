...
URL Source: https://api-docs.aevo.xyz/reference/getreferralstatistics

Markdown Content:
GET /referral-statistics
=============== 

[Jump to Content](https://api-docs.aevo.xyz/reference/getreferralstatistics#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getreferralstatistics)[![Image 5: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getreferralstatistics)
...
get https://api.aevo.xyz/referral-statistics
...
total\_rewards\_unclaimed

string

required

Total amount of rewards earned by an account for being a referrer or referee that has not been claimed Eg. `69.2`

total\_referral\_bonus\_unclaimed

string

required

Total amount of rewards earned by an account for being a referrer that has not been claimed Eg. `69.2`

total\_referee\_discount\_unclaimed

string

required

Total amount of rewards earned by an account for being a referee that has not been claimed Eg. `69.2`

total\_trading\_fees\_rewards
...
total\_trading\_fees\_rewards\_volume
...
[GET /referral-rewards-history](https://api-docs.aevo.xyz/reference/getreferralrewardshistory)[POST /claim-referral-rewards](https://api-docs.aevo.xyz/reference/postclaimreferralrewards)
...
2
     ...
     \--url https://api.aevo.xyz/referral-statistics \\
