Title: GET /account/email-address

URL Source: https://api-docs.aevo.xyz/reference/getaccountemailaddress
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getaccountemailaddress#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountemailaddress)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountemailaddress)
...
get https://api.aevo.xyz/account/email-address
