Title: GET /coingecko-statistics

URL Source: https://api-docs.aevo.xyz/reference/getcoingeckostatistics
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getcoingeckostatistics#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getcoingeckostatistics)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getcoingeckostatistics)
...
Returns the perpetual statistics of all assets specifically for [https://www.coingecko.com/en/exchanges/aevo](https://www.coingecko.com/en/exchanges/aevo)
