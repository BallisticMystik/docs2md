...
URL Source: https://api-docs.aevo.xyz/reference/subcribe-trades
...
[Jump to Content](https://api-docs.aevo.xyz/reference/subcribe-trades#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/subcribe-trades)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/subcribe-trades)
...
| data.**trade\_id** string required  
...
| data.**side** object required  
Trade side. Allowed values: `buy` `sell` |
| data.**price** object required  
