Title: POST /account/update-margin

URL Source: https://api-docs.aevo.xyz/reference/postaccountupdatemargin
...
[Jump to Content](https://api-docs.aevo.xyz/reference/postaccountupdatemargin#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountupdatemargin)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountupdatemargin)
...
post https://api.aevo.xyz/account/update-margin
