Title: POST /reset-mmp

URL Source: https://api-docs.aevo.xyz/reference/postresetmmp
...
[Jump to Content](https://api-docs.aevo.xyz/reference/postresetmmp#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postresetmmp)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postresetmmp)
...
post https://api.aevo.xyz/reset-mmp
