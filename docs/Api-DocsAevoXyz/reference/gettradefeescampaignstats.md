Title: GET /trade-fees-campaign-stats

URL Source: https://api-docs.aevo.xyz/reference/gettradefeescampaignstats
...
[Jump to Content](https://api-docs.aevo.xyz/reference/gettradefeescampaignstats#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/gettradefeescampaignstats)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/gettradefeescampaignstats)
...
get https://api.aevo.xyz/trade-fees-campaign-stats
