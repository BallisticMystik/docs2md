Title: GET /strategy/{strategy_address}/transaction-history

URL Source: https://api-docs.aevo.xyz/reference/getstrategystrategyaddresstransactionhistory

Markdown Content:
GET /strategy/{strategy\_address}/transaction-history
===============
                                                                                                             

[Jump to Content](https://api-docs.aevo.xyz/reference/getstrategystrategyaddresstransactionhistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategystrategyaddresstransactionhistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategystrategyaddresstransactionhistory)
...
get https://api.aevo.xyz/strategy/{strategy\_address}/transaction-history
