...
URL Source: https://api-docs.aevo.xyz/reference/postordersorderid

Markdown Content:
POST /orders/{order\_id}
===============
                                                                        

[Jump to Content](https://api-docs.aevo.xyz/reference/postordersorderid#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postordersorderid)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postordersorderid)
...
post https://api.aevo.xyz/orders/{order\_id}
