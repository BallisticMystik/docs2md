...
URL Source: https://api-docs.aevo.xyz/reference/getorderhistory
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getorderhistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getorderhistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getorderhistory)
...
get https://api.aevo.xyz/order-history
