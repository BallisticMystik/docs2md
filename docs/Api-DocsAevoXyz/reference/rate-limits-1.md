...
URL Source: https://api-docs.aevo.xyz/reference/rate-limits-1
...
[Jump to Content](https://api-docs.aevo.xyz/reference/rate-limits-1#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/rate-limits-1)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/rate-limits-1)
...
[](https://api-docs.aevo.xyz/reference/rate-limits-1#rate-limits-on-rest-api)
--------------------------------------------------------------------------------------------------------
...
[](https://api-docs.aevo.xyz/reference/rate-limits-1#rate-limits-on-websocket-api)
------------------------------------------------------------------------------------------------------------------
