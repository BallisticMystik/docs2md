Title: PUBLISH Cancel All Orders

URL Source: https://api-docs.aevo.xyz/reference/publish-cancel-all-orders
...
[Jump to Content](https://api-docs.aevo.xyz/reference/publish-cancel-all-orders#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/publish-cancel-all-orders)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/publish-cancel-all-orders)
...
| data.**instrument\_type** string optional  
...
| data.**order\_ids** array of strings required  
