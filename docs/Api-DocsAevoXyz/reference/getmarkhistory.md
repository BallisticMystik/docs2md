Title: GET /mark-history

URL Source: https://api-docs.aevo.xyz/reference/getmarkhistory
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getmarkhistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getmarkhistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getmarkhistory)
...
get https://api.aevo.xyz/mark-history
