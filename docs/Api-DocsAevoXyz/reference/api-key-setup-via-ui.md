...
URL Source: https://api-docs.aevo.xyz/reference/api-key-setup-via-ui
...
[Jump to Content](https://api-docs.aevo.xyz/reference/api-key-setup-via-ui#content)

[![Image 15: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/api-key-setup-via-ui)[![Image 16: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/api-key-setup-via-ui)
...
[](https://api-docs.aevo.xyz/reference/api-key-setup-via-ui#1-add-network-to-your-wallet)
===========================================================================================================================
...
*   `ChainID`: 11155111
*   `RPC`: [https://l1-aevo-devnet-yl1nvpe4fq.t.conduit.xyz](https://l1-aevo-devnet-yl1nvpe4fq.t.conduit.xyz/)
*   `Block Explorer`: [https://explorerl1-aevo-devnet-yl1nvpe4fq.t.conduit.xyz](https://explorerl1-aevo-devnet-yl1nvpe4fq.t.conduit.xyz/)

2\. Enable Trading

[](https://api-docs.aevo.xyz/reference/api-key-setup-via-ui#2-enable-trading)
===================================================================================================
...
![Image 17: 688](https://files.readme.io/a392f46-connect_wallet_new.png)Connect your wallet using either Metamask, Wallet Connect or Coinbase Wallet.

![Image 18: 646](https://files.readme.io/04f431c-wallet_select.png)Click the `Sign Message` button. Optionally, you can disable `Remember Me` which only generates a temporary session key for trading.

![Image 19: 720](https://files.readme.io/dd5f0b5-enable_trading.png)Sign the message from your wallet. Below is an example of how it looks like on Metamask:

![Image 20: 714](https://files.readme.io/4cef4a7-metamask_popup.png)If you are not able to enable trading, please double check that you are connected to Aevo testnet.
...
![Image 21: 712](https://files.readme.io/f9065b7-deposit_popup.png)

3\. Create an API Key

[](https://api-docs.aevo.xyz/reference/api-key-setup-via-ui#3-create-an-api-key)
=========================================================================================================
...
*   Mainnet: [https://app.aevo.xyz/settings/api-keys](https://app.aevo.xyz/settings/api-keys)
*   Testnet: [https://testnet.aevo.xyz/settings/api-keys](https://testnet.aevo.xyz/settings/api-keys)
...
![Image 22](https://files.readme.io/96a8590-api_key_new.png)
