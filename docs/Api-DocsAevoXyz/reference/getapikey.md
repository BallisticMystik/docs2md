...
URL Source: https://api-docs.aevo.xyz/reference/getapikey
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getapikey#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getapikey)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getapikey)
...
get https://api.aevo.xyz/api-key
