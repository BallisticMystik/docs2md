Title: GET /strategy/{strategy_address}/trade-history

URL Source: https://api-docs.aevo.xyz/reference/getstrategystrategyaddresstradehistory

Markdown Content:
GET /strategy/{strategy\_address}/trade-history
===============
                                                                                                          

[Jump to Content](https://api-docs.aevo.xyz/reference/getstrategystrategyaddresstradehistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategystrategyaddresstradehistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategystrategyaddresstradehistory)
...
get https://api.aevo.xyz/strategy/{strategy\_address}/trade-history
