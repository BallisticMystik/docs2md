Title: DELETE /quotes/{quote_id}

URL Source: https://api-docs.aevo.xyz/reference/deletequotesquoteid
...
[Jump to Content](https://api-docs.aevo.xyz/reference/deletequotesquoteid#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/deletequotesquoteid)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/deletequotesquoteid)
...
delete https://api.aevo.xyz/quotes/{quote\_id}
