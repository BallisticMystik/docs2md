Title: GET /account/accumulated-fundings

URL Source: https://api-docs.aevo.xyz/reference/getaccountaccumulatedfundings
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getaccountaccumulatedfundings#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountaccumulatedfundings)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountaccumulatedfundings)
...
get https://api.aevo.xyz/account/accumulated-fundings
