Title: POST /account/cancel-on-disconnect

URL Source: https://api-docs.aevo.xyz/reference/postaccountcancelondisconnect
...
[Jump to Content](https://api-docs.aevo.xyz/reference/postaccountcancelondisconnect#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountcancelondisconnect)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountcancelondisconnect)
...
post https://api.aevo.xyz/account/cancel-on-disconnect
