...
URL Source: https://api-docs.aevo.xyz/reference/overview
...
[Jump to Content](https://api-docs.aevo.xyz/reference/overview#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/overview)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/overview)
...
*   Mainnet: [https://api.aevo.xyz](https://api.aevo.xyz/)
*   Testnet: [https://api-testnet.aevo.xyz](https://api-testnet.aevo.xyz/)
...
*   Python: [https://github.com/aevoxyz/aevo-sdk](https://github.com/aevoxyz/aevo-sdk)

For any questions, feedback and request for SDK access, reach out to [ken@ribbon.finance](mailto:ken@ribbon.finance).
