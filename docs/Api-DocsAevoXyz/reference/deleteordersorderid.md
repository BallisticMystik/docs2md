Title: DELETE /orders/{order_id}

URL Source: https://api-docs.aevo.xyz/reference/deleteordersorderid
...
[Jump to Content](https://api-docs.aevo.xyz/reference/deleteordersorderid#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/deleteordersorderid)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/deleteordersorderid)
...
delete https://api.aevo.xyz/orders/{order\_id}
