Title: GET /strategy/{strategy_address}/balance-history

URL Source: https://api-docs.aevo.xyz/reference/getstrategystrategyaddressbalancehistory

Markdown Content:
GET /strategy/{strategy\_address}/balance-history
===============
                                                                                                        

[Jump to Content](https://api-docs.aevo.xyz/reference/getstrategystrategyaddressbalancehistory#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategystrategyaddressbalancehistory)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getstrategystrategyaddressbalancehistory)
...
get https://api.aevo.xyz/strategy/{strategy\_address}/balance-history
