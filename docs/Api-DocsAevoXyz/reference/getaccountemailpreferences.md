Title: GET /account/email-preferences

URL Source: https://api-docs.aevo.xyz/reference/getaccountemailpreferences
...
[Jump to Content](https://api-docs.aevo.xyz/reference/getaccountemailpreferences#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountemailpreferences)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/getaccountemailpreferences)
...
get https://api.aevo.xyz/account/email-preferences
