Title: POST /account/margin-type

URL Source: https://api-docs.aevo.xyz/reference/postaccountmargintype
...
[Jump to Content](https://api-docs.aevo.xyz/reference/postaccountmargintype#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountmargintype)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/postaccountmargintype)
...
post https://api.aevo.xyz/account/margin-type
