...
URL Source: https://api-docs.aevo.xyz/reference/websocket-authentication
...
[Jump to Content](https://api-docs.aevo.xyz/reference/websocket-authentication#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/websocket-authentication)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/websocket-authentication)
...
[](https://api-docs.aevo.xyz/reference/websocket-authentication#authenticate-per-connection)
---------------------------------------------------------------------------------------------------------------------------
...
[](https://api-docs.aevo.xyz/reference/websocket-authentication#authenticate-per-message)
---------------------------------------------------------------------------------------------------------------------
...
*   `ws` is a string constant with the value "ws". _Must be lowercase_.
