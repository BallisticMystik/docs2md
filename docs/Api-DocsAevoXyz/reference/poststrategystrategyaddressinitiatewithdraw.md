Title: POST /strategy/{strategy_address}/initiate-withdraw

URL Source: https://api-docs.aevo.xyz/reference/poststrategystrategyaddressinitiatewithdraw

Markdown Content:
POST /strategy/{strategy\_address}/initiate-withdraw
===============
                                                                                                           

[Jump to Content](https://api-docs.aevo.xyz/reference/poststrategystrategyaddressinitiatewithdraw#content)
...
[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/poststrategystrategyaddressinitiatewithdraw)[![Image 4: Aevo Exchange](https://files.readme.io/dbce2d9-Aevo_Logotype_White.svg)](https://api-docs.aevo.xyz/reference)

API Reference

[Log In](https://api-docs.aevo.xyz/login?redirect_uri=/reference/poststrategystrategyaddressinitiatewithdraw)
...
post https://api.aevo.xyz/strategy/{strategy\_address}/initiate-withdraw
